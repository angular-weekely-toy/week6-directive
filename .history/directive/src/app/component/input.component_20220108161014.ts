...
@Component({
	selector: 'jrd-input',
	templateUrl: './jrd-input.component.html',
	styleUrls: ['./jrd-input.component.scss'],
	providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => JrdInputComponent), multi: true }],
})
export class JrdInputComponent implements ControlValueAccessor, OnInit {
	@Input() title: string;
